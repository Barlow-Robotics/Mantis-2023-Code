...
public class AlignWithAprilTags extends CommandBase {
    ...
    public AlignWithAprilTags(Vision v, Drive d) {
        driveSub = d;
        visionSub = v;
    ...
    @Override
    public void execute() {
        if (visionSub.aprilTagIsVisible() && (visionSub.bbAprilTagWidth() > 50 || visionSub.bbAprilTagHeight() > 85)) {
